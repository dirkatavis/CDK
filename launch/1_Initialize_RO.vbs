...
' WRAPPER_TARGET: apps\repair_order\initialize\1_Initialize_RO.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "apps\repair_order\initialize\1_Initialize_RO.vbs")

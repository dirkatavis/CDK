...
' WRAPPER_TARGET: apps\repair_order\0_initialize\0_Initialize_RO.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "apps\repair_order\0_initialize\0_Initialize_RO.vbs")

...
' WRAPPER_TARGET: apps\post_final_charges\PostFinalCharges.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "apps\post_final_charges\PostFinalCharges.vbs")

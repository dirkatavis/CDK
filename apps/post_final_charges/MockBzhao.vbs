...
Class MockBzhao
    ...
    Public Function IsConnected()
        IsConnected = m_mock.IsConnected()
    End Function
    Public Function GetSentKeys()
        GetSentKeys = m_mock.GetSentKeys()
    End Function
End Class

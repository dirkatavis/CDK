...
' WRAPPER_TARGET: utilities\maintenance_ro_closer\Maintenance_RO_Closer.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "utilities\maintenance_ro_closer\Maintenance_RO_Closer.vbs")

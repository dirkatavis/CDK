...
' WRAPPER_TARGET: utilities\post_final_charges\PostFinalCharges.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "utilities\post_final_charges\PostFinalCharges.vbs")

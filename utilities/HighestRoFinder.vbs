...
' WRAPPER_TARGET: utilities\highest_ro_finder\HighestRoFinder.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "utilities\highest_ro_finder\HighestRoFinder.vbs")

...
' WRAPPER_TARGET: workflows\repair_order\initialize_ro\1_Initialize_RO.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "workflows\repair_order\initialize_ro\1_Initialize_RO.vbs")

...
' WRAPPER_TARGET: workflows\repair_order\finalize_close_pt2\3_Finalize_Close_Pt2.vbs
...
Dim targetPath: targetPath = fso.BuildPath(basePath, "workflows\repair_order\finalize_close_pt2\3_Finalize_Close_Pt2.vbs")
